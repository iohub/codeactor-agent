...
| 单智能体，单打独斗 | 🤖 **中枢-辐条多智能体**：Conductor 统一指挥，六大脑各司其职 |
...
| Agent | 角色 | 核心能力 |
|-------|------|----------|
| 🎼 **Conductor** | 指挥家 | 任务分解、动态规划、代理委派、结果评审 |
...
这是 CodeActor 最独特的能力。当 Conductor 遇到内置 Agent 无法胜任的任务时，**Meta-Agent** 会：
...
内置无头 Chrome 浏览器（go-rod），自主导航网页、提取文档、填写表单。当本地上下文不足时，Conductor 自动委派网络调研任务。
