...
func newTestConductorAgent(t *testing.T, workDir string) *ConductorAgent {
	...
	engine := &mockEngine{}
	return NewConductorAgent(gctx, engine, nil, nil, nil, nil, nil, nil, 10, nil, 3, nil, nil, config.Config{}, nil, nil)
}
...
func TestCustomAgentDelegateTool_Execution(t *testing.T) {
	...
	conductor := NewConductorAgent(gctx, customEngine, nil, nil, nil, nil, nil, nil, 10, nil, 3, nil, nil, config.Config{}, nil, nil)
