...
*   **Context Gathering**:
    ...
    *   **High Priority (Use first)**: `get_repo_overview`, `semantic_search`, `query_code_skeleton`, `query_code_snippet`, `print_dir_tree`. These tools provide high-level context and structure efficiently.
